...
- 登录页：[http://127.0.0.1:9001/login（**正式入口**：注册](http://127.0.0.1:9001/login（**正式入口**：注册) / 登录后进入农场）
- 前端根路径会按会话跳到登录或农场：[http://127.0.0.1:9001/](http://127.0.0.1:9001/)
- 后端：[http://127.0.0.1:9002/](http://127.0.0.1:9002/)
- Admin（默认仅 loopback，与业务端口隔离）：[http://127.0.0.1:9300/](http://127.0.0.1:9300/)
...
1. **账号 A**：打开 [http://127.0.0.1:9001/login](http://127.0.0.1:9001/login) →「注册」→ 进入自己的农场。
