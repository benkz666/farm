// Package obs provides process health probes, Prometheus metrics, admin HTTP
...
// DefaultAdminAddr is the loopback-only admin listener used when FARM_ADMIN_ADDR is unset.
// 9300 避开默认拓扑：Vite 9001/9003、业务 HTTP 9002、Farm 9100/9101、Gateway 9200/9201、Kafka 9094。
const DefaultAdminAddr = "127.0.0.1:9300"

// ParseAdminAddr maps FARM_ADMIN_ADDR to a listen address.
